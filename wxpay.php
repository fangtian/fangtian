  		...
  		<div class="content">
  			<div class="row">
  				<div class="order_info">
  					<div class="col-md-6">
  						<p class="notice"><strong>请您及时付款，以便订单快速处理！订单号：1000477733222</strong></p>
  						<p>请您在提交订单后<span class="sum">24</span>小时内完成支付，否则订单会自动取消。</p>
  					</div>
  					<div class="col-md-6 order_detail_price">
  			...
  			<div class="row">
  				<div class="wxpay_detial clearfix">
            <h4 class="head">微信支付</h4>
            <div class="col-sm-6">
              <div class="qrcode">
                <img src="_/images/qrcode.png" alt="">
              </div>
            ...
            <div class="col-sm-6">
              <div class="show_in_picture">
                <img src="_/images/phone-bg.png" alt="">
              </div>
            </div> <!-- col-sm-6 -->
            <div class="return">
            ...
            <div class="confirm">
              <div id="pay_success" class="btn btn-info col-md-6">如果支付成功后页面没有跳转到我的个人中心请点击这里</div>
