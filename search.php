      ...
      <div class="search-area clearfix">
        <div class="col-md-4 col-md-offset-4">
          <div class="search_form">
            <form action="exam-result.php">
              <div class="subject">
                <label class="title" for="">合肥方田成绩查询平台</label>
              </div>
              <fieldset>
                <div class="form-group">
                  <label for="numberForExam">准考证号</label>
                  <input type="text" class="form-control" id="numberForExam" placeholder="准考证号">
                </div>
                <div class="form-group">
                  <label for="name">学员姓名</label>
                  <input type="text" class="form-control" id="name" placeholder="学员姓名">
                </div>
