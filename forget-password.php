          ...
          <div class="login_form">
            <form action="">
              ...
              <fieldset>
                ...
                <div class="form-group">
                  <div class="btn btn-warning">获取手机验证码</div>
                </div>
                <div class="form-group">
                  <label for="validate">你收到的短信验证码</label>
                  <input type="text" class="form-control" id="validate" placeholder="验证码">
                </div>
                <div class="form-group">
                  <label for="password">您的密码</label>
                  <input type="password" class="form-control" id="password" placeholder="密码">
                  <input type="password" class="form-control" id="password" placeholder="再次输入密码">
                </div>
                <div class="form-group">
                  <div class="alert alert-success" role="alert">密码重置成功，3秒后跳入登入页面</div>
                </div>
                <button type="submit" class="btn btn-info">密码重置</button>
              </fieldset>
            </form>
          </div>
        </div>
