    ...
    <div>
      <section class="col-lg-8 col-md-8">
        <div class="userinfo">
          ...
          <form class="form-horizontal" role="form">
             ...
             <div class="form-group">
                ...
                <div class="radio col-sm-1">
                  <label>
                    <input type="radio" name="sexradio" id="sexradio" value="male" checked>
                    男
                  </label>
                </div>
                <div class="radio col-sm-1">
                  <label>
                    <input type="radio" name="sexradio" id="sexradio" value="female" checked>
                    女
                  </label>
                </div>
             </div>
             <div class="form-group">
                <label for="level" class="col-sm-2 control-label">年级</label>
                <div class="col-sm-2">
             ...
             <div class="form-group">
                <label for="parent_phone1" class="col-sm-2 control-label">家长电话1</label>
                <div class="col-sm-4">
                   <input type="text" class="form-control" id="parent_phone1" 
                      placeholder="手机号码">
                </div>
                <div class="col-sm-2">
                   <select class="form-control">
                ...
                <div class="col-sm-2">
                   <input type="text" class="form-control" placeholder="家长名字">
                </div>
             </div>
             <div class="form-group">
                <label for="parent_phone2" class="col-sm-2 control-label">家长电话2</label>
                <div class="col-sm-4">
                   <input type="text" class="form-control" id="parent_phone2" 
                      placeholder="手机号码">
                </div>
                <div class="col-sm-2">
                   <select class="form-control">
          ...
          <form class="form-horizontal" role="form">
            <div class="form-group">
                <label class="col-sm-4 control-label"><span class="glyphicon glyphicon-phone" aria-hidden="true"></span> 通过手机短信重置密码</label>
                <div class="col-sm-4">
                   <button type="button" class="btn btn-danger">重置密码</button>
                </div>
             </div>
