...
<html lang="en">
  ...
  <section id="portrait">
        ...
        <div class="portrait">
          ...
          <form class="form-horizontal" role="form">
             ...
             <div class="upload_img">
               <img src="_/images/default_portrait_b.png" alt="">
             </div>
             ...
             <div class="form-group">
                <div class="form-group">
                 ...
                 <div class="col-sm-6 col-xs-12">
                   <input id="fileupload" type="file" name="mypic" class="btn btn-success">
                 </div>
             ...
             <p class="rule_upload">仅支持JPG、GIF、PNG、JPEG、BMP格式，文件小于4M</p>
          </form>
    ...
    <div>
      <section class="col-lg-2 col-md-3">
        <div class="browser">
          <h5>效果预览</h5>
          <p>你上传的图片会自动生成2种尺寸，请注意小尺寸的头像是否清晰</p>
          <img src="_/images/default_portrait_m.png" alt="">
          <p>200x200像素</p>
          <img src="_/images/default_portrait_s.png" alt="">
          <p>35x35像素</p>
