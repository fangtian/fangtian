  			...
  			<div class="row">
  				<div class="choose_method">
  					<div class="col-sm-6">
  						<div class="alipay">
  							<div class="icon">
  								<img class="btn" src="_/images/alipay_icon.png" alt="通过支付宝支付" id="alipay">
  							</div>
  							<div class="title btn btn-success" id="alipay">
  								使用支付宝支付
  							</div>
  					...
  					<div class="col-sm-6">
  						<div class="wxpay">
  							<div class="icon">
  								<img class="btn" src="_/images/wxpay_icon.png" alt="通过微信支付" id="wxpay">
  							</div>
  							<div class="title btn btn-success" id="wxpay">
  								使用微信支付
  							</div>
  						</div> <!-- wxpay -->
  					</div>
